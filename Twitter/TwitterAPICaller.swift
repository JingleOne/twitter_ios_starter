...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func postTweet(tweetContent:String, success: @escaping () -> (), failure: @escaping (Error) -> ()){
    ...
    func fav_tweet(tweetID:Int, success: @escaping () -> (), failure: @escaping (Error) -> ()){
    ...
    func unfav_tweet(tweetID:Int, success: @escaping () -> (), failure: @escaping (Error) -> ()){
    ...
    func retweet_request(tweetID:Int, success: @escaping () -> (), failure: @escaping (Error) -> ()){
